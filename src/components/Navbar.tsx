          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
                    ...
                    >
                      {item.submenu.map((subItem) => (
                        <Link
                          key={subItem.name}
                          href={subItem.href}
                          className="block px-4 py-2 text-gray-900 hover:bg-amber-50 hover:text-amber-700"
                          role="menuitem"
                        >
                          {subItem.name}
                        </Link>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-1 text-gray-900 hover:text-amber-700"
                  ...
                  >
                    {languages.map((lang) => (
                      <button
                        ...
                        className="block w-full text-left px-4 py-2 text-gray-900 hover:bg-amber-50 hover:text-amber-700"
                        role="menuitem"
                      >
                        {lang.name}
                      </button>
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-900 hover:text-amber-700 hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-amber-500"
                      ...
                      <div className="pl-4 mt-2 space-y-2">
                        {item.submenu.map((subItem) => (
                          <Link
                            key={subItem.name}
                            href={subItem.href}
                            className="block text-gray-900 hover:text-amber-700"
                            onClick={() => setIsOpen(false)}
                            role="menuitem"
                          >
                            {subItem.name}
                      ...
                      <button
                        ...
                        className={`block w-full text-left px-3 py-2 rounded-md ${
                          currentLanguage === lang.code
                            ...
                            : 'text-gray-900 hover:bg-amber-50 hover:text-amber-700'
                        }`}
                        role="menuitem"
                      >
                        {lang.name}
